/**
 ...
 function main(params) {
    ...
    if (params.agreementID == null || params.agreementID == "") { return { "error": "AgreementID is empty" };}
	...
	return ow.actions.invoke({ actionName: 'common-ow/digital-locker', blocking: true, result: true }).then(result => {
            ...
            var url = sysDetails.api_protocol + "://" + sysDetails.api_hostname + sysDetails.api_path + '/agreements/' + params.agreementID + '/exists';
            var options = {
                method: 'GET',
                url: url,   
                headers: {
