...
const namespace = 'org.dxc.dip';
const assetType = 'ProofAsset';
...
describe('#' + namespace, () => {
    ...
    describe('FindProof()', () => {
        it('should find ProofAsset with provided agreement hash', () => {
            const factory = businessNetworkConnection.getBusinessNetwork().getFactory();
            return true;
            // Create a user participant
            // const user = factory.newResource(namespace, 'User', 'Tinh Do');
